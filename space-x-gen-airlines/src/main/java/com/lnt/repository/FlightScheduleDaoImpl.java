...
public class FlightScheduleDaoImpl implements FlightScheduleDao {
	...
	@Override
	public List<FlightSchedule> searchScheduleByDateAndTime(String date, String time) {
		// TODO Auto-generated method stub
		String jpql="select fs from FlightSchedule fs where fs.date=?1 AND fs.time=?2";
